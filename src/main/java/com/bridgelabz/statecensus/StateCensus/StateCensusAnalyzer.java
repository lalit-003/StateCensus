...
try
{
		while (stateIterator.hasNext()) {
			...
			if (CSVStateCensus.getStateName() == null || Integer.parseInt(CSVStateCensus.getPopulation()) == 0
					|| Integer.parseInt(CSVStateCensus.getDensityPerSqKm()) == 0
...
// finally is used only to return count of states
finally
{
	// last count increment will not occur because it will throw runtime exception
	return count+1;
}
	}
